...
practice_levels <- c("p0","p1","p2","p3","p4","p5","p6","p7","p8","p9","p10","p11","p12")
practice_labels <- c("Apply Data Classification Scheme", "Apply Security Requirements", "Apply Threat Modeling", "Document Technical Stack", "Apply Secure Coding Standards", "Apply Security Tooling", "Perform Security Testing", "Perform Penetration Testing", "Perform Security Review", "Publish Operations Guide", "Track Vulnerabilities", "Improve Development Process","Perform Security Training")

role_levels <- c("de", "qa", "pm", "re", "ux", "id", "da", "ba", "se", "ot")
# todo: get role labels, update here
role_labels <- c("Developer", "Tester", "Project Management", "Requirements Engineer", "Designer/UX", "Technical Writer/Documentation", "Database Administrator", "Build Administrator", "Security", "Other")
